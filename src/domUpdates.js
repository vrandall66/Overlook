...
const domUpdates = {
  ...
  displayAvailableRoomsOnSpecifiedDate(room) {
    $(`<span id="all-available-rooms-day" data-id="${room.number}">Room Number: ${room.number}: Room Type: ${room.roomType} Bed Size: ${room.bedSize}</span></ br>`).appendTo($("#all-previous-bookings"))
  },
